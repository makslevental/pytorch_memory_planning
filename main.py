...
from profile import get_required_mem_allocs, profile_model, load_model, get_mem_events, make_resnets
from strategies import (
    greedy_by_size,
    find_gap,
    GapPriority,
    greedy_by_longest, bump_allocator, solve_mip, solve_cp,
)
...
if __name__ == "__main__":
    ...
    profile_model(model, torch.rand((1, 3, 224, 244)), name)
