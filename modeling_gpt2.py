...
from transformers import Conv1D, PreTrainedModel, GPT2Config
...
from transformers.modeling_utils import find_pruneable_heads_and_indices, prune_conv1d_layer, SequenceSummary
